...
public class AppSettingsHandler extends DefaultHandler {
    ...
    private final String tag_feed_link = "feed_link";
    private final String tag_feed_lang = "feed_lang";
    ...
    private final String tag_incident_description = "incident_description";
    private final String tag_pgp_public = "pgp_public";
    private final String tag_pgp_id = "pgp_id";
    private final String tag_pgp_fingerprint = "pgp_fingerprint";
    private final String tag_pgp_pubkey = "pgp_pubkey";
    private final String tag_supported_langs = "supported_langs";
    private final String tag_supported_lang = "supported_lang";
    private final String tag_translation = "translation";
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        switch (qName) {
            case tag_base64_logo: {
                AppSettingsProperty appSettingsProperty = new AppSettingsProperty(AppSettingsOption.app_settings_logo_base64, elementValue.build().trim());
                properties.add(appSettingsProperty);
            }
            break;
            case tag_default_lang: {
                AppSettingsProperty appSettingsProperty = new AppSettingsProperty(AppSettingsOption.app_settings_lang_default, elementValue.build().trim());
                properties.add(appSettingsProperty);
            }
            break;
            case tag_feed_link: {
                getLastFeedSettings().setLink(elementValue.build().trim());

            }
            break;
            case tag_feed_lang: {
                getLastFeedSettings().setLang(elementValue.build().trim());
            }
            break;
            ...
            break;
            case tag_incident_description: {
                getLastCategory().setDescription(elementValue.build());

            }
            break;
            case tag_pgp_id: {
                getLastEmailReporting().setPgpId(elementValue.build().trim());
            }
            break;
            case tag_pgp_fingerprint: {
                getLastEmailReporting().setPgpFingerprint(elementValue.build().trim());
            }
            break;
            case tag_pgp_pubkey: {
