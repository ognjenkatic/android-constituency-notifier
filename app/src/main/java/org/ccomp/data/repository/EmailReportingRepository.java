...
public class EmailReportingRepository {
    ...
    @Inject
    public EmailReportingRepository(EmailReportingDAO emailReportingDAO, IncidentCategoryDAO incidentCategoryDAO, EmailReportingIncidentCategoryMappingDAO mappingDAO, ExecutorService executorService, NetworkAvailabilityService networkAvailabilityService) {
    ...
    public LiveData<List<EmailReporting>> getAllEmailReporting() {
        ...
        executorService.execute(() -> {
            ...
            for (EmailReporting emailReporting : all) {
                List<String> keys = mappingDAO.getEmailAddressKeysByIncidentCategoryIdSync(emailReporting.getAddress());
    ...
    public LiveData<Resource<List<EmailReporting>>> loadEmailReportingLocal() {
        return loadEmailReporting("", false);
    }
